import webbrowser
webbrowser.open('https://t.me/illegalkatana')
try:
...
def mouad9():
  ...
  azro = (f"""        {Z}┏{B}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━{Z}┓
   ---------🇹🇷--------KATANA----------🇹🇷------------           {X}Telegram  :          https://t.me/KatanaArsiv\n        {Z}┗{X}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━{Z}┛\n\n\n\n""")
...
sid = input(f'{Z}┇ {C}➯{C} ┇{S}  Session Id{Y} » ' + B)

print('')

token = input(f'{Z}┇ {C}➯{C} ┇{S}Bot Token {Y}     » ' + B)
print('')
ID = input(f'{Z}┇ {C}➯{C} ┇{S} Telegram Id{Y}     » ' + B)
print(F+'⌯⌯⌯⌯⌯⌯⌯⌯⌯⌯⌯⌯⌯⌯⌯⌯⌯⌯⌯⌯⌯⌯⌯⌯⌯⌯⌯⌯⌯⌯⌯⌯⌯⌯⌯⌯⌯⌯⌯⌯⌯⌯⌯⌯⌯⌯⌯⌯⌯⌯⌯⌯⌯⌯⌯⌯⌯⌯⌯⌯ ')
...
---------------------------KATANA-----------------------------           {X}Telegram  :         https://t.me/KatanaArsiv\n        {Z}┗{X}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━{Z}┛\n\n\n\n""")
   ...
   print(f'   ❖ {C1}{X} {email}    ')
   print('•••••••••••••••••••••••••••••••••')
   print(f' {C1} {R}{F}❖{R} {F}✅Düştü {B}      : {F}{SS}            \n {C1} {R}{R}❖{R} {R} ⚠Şüpheli {B}  : {R}{i}      {C1}       \n  {R}{X}❖{R} {X}🛇Çalışmayan {B}: {X}{BB}    {F}        ')
   print('•••••••••••••••••••••••••••••••••')
   print('   ❖ Coding : ❖ @illegalkatana ❖')
   SS+=1
